    ...
    <div style="max-width: 900px; margin: auto;">
      ...
      <div class="faq-container">
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer">Yes, our basic invoice formats are free to use.</div>
        </div>
        <div class="faq-item">
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (incTarget > 0) {
    ...
    const incInt = setInterval(() => {
      ...
      incElem.textContent = "₹" + inc.toLocaleString(undefined, {
    ...
    incElem.textContent = "₹0.00";
  }
  // ─── FAQ Accordion ────────────────────────────────────
  document.querySelectorAll('.faq-question').forEach(button => {
    button.addEventListener('click', () => {
      const ans = button.nextElementSibling;
      document.querySelectorAll('.faq-answer').forEach(x => { if (x!==ans) x.style.display='none' });
